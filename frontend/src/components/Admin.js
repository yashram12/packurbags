    ...
    <>
      ...
      <Container style={{maxWidth:"100vw"}}>
        <Row style={{margin:'1rem auto'}}>
          ...
          <Col lg={3} sm={6} xs={12} style={{height:"10rem",margin:"1rem auto",borderRadius:"5px"}}>
            <h4 className="text-center">Total Number of Places</h4> <h1 className="text-center">40</h1>
          </Col>
          <Col lg={3} sm={6} xs={12} style={{height:"10rem",margin:"1rem auto",borderRadius:"5px"}}>
            <h4 className="text-center">Total Number of Tours</h4> <h1 className="text-center">40</h1>
          </Col>
          <Col lg={3} sm={6} xs={12} style={{height:"10rem",margin:"1rem auto",borderRadius:"5px"}}>
